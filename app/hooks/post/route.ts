/**
 * `POST /hooks/post`: Arcade's post hook: what the model may read of the result → `{ code, override? }`.
 *
 ...
 * on #4. The service served it at `/post`, and `mountedFetch` hands the module
 * that path.
 */
